...
def page_summary_body():
    ...
    st.success(
        ...
        f"We will inspect the data related to the housing prices and features."
        f"We will conduct a correlation study (Pearson and Spearman) to understand better how features interact with the sales price."
