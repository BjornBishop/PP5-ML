...
from app_pages.page_prediction import page_sale_price_prediction
from app_pages.page_predict_price import page_predict_sale_price
...
app.add_page("Predict Sale Price", page_predict_sale_price)
